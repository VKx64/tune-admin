...
export default function LoginPage() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      const { token, record } = await pb.collection('users').authWithPassword(email, password, { requestKey: null });

      // The user is authenticated, and the auth data is saved in pb.authStore
